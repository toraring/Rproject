...
View(bank)
[피드백]
1번 문제에서 데이터 확인 시 View 함수를 사용하셨는데요~! 데이터 크기가 큰 경우 로드에 상당한 시간이 걸려 버퍼링이 걸릴 수 있습니다.
데이터 확인은 가급적 1-(1)문에서 작성하신 함수들을 사용하는 것을 추천드립니다. 
...
[피드백]
2-(3) : 여러 그룹의 평균을 비교하므로 anova를 사용하셔야합니다. 10점 감점
